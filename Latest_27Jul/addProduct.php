 ...
 <body>  
    ...
    <nav class="navbar navbar-expand-md navbar-light">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<li class="nav-item">
                <a href=""class="nav-link" onclick="$('#forHimForm').submit(); return false;" title="For Him">For Him</a>   
            </li>
			<li class="nav-item">
                <a href="" class="nav-link" onclick="$('#forHerForm').submit(); return false;" title="For Her">For Her</a>
	...
	<form id="forHimForm" action="searchResult.php" method="post" style="display: none">
  <input type="hidden" name="search" value="Male">
</form>
	<form id="forHerForm" action="searchResult.php" method="post" style="display: none">
  <input type="hidden" name="search" value="Female">
</form>
  ...
  <div class="container" style="width:700px;">  
   <h3 align="center">Add Product - Admin Module</h3>  
   <br />  
