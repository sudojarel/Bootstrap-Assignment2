  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active" max-height="800px">
      ...
      <div class="carousel-caption">
        <h3 class="h3-responsive">Amazing deals here everyday!</h3>
        <p>Get yours now</p>
      </div>	
    </div>
    <div class="carousel-item">
      ...
      <div class="carousel-caption">
        <h3 class="h3-responsive">Look good with a budget</h3>
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption">
        <h3 class="h3-responsive">Find something amazing today</h3>
	 ...
	 <div class="carousel-item">
      ...
      <div class="carousel-caption">
        <h3 class="h3-responsive">Start shopping now</h3>
